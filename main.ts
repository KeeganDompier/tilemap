...
function buildLevel () {
    // If level equals length of array length, then YOU
    // WIN
    //
    ...
    // places the player at a certain position when
...
let nextLevel = 0
let levels: Image[] = []
// sorting levels in an array list
levels = [img`
f f f f f f f f f f 
f f f f f f f f f f 
f f f f f f f f f f 
...
3 3 3 3 3 3 3 3 3 3 
`]
// It makes the block look like a face and creates a
// wall
scene.setTile(7, img`
